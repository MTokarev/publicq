...
**Note:** Icons located in `/client/public/images/icons/` are licensed separately and are not covered by the project's open-source license. See the [Icons](#-icons) section above for details.
